...
public class Field {
	...
	*/
	 ...
	 * @return the atkUnits
	 */
	public int getAtkUnits() {
		return atkUnits;
	}

	/**
	 * @param atkUnits the atkUnits to set
	 */
	public void setAtkUnits(int atkUnits) {
		this.atkUnits = atkUnits;
	}
	...
	/**
	 * @param defUnits the defUnits to set
	 */
	public void setDefUnits(int defUnits) {
